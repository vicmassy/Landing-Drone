...
double initTime = 0;
double limit = 1.0;
double sum_error_x = 0.0, sum_error_y = 0.0;
double last_error_x = 0.0, last_error_y = 0.0;
...
int main(int argc, char **argv) {
    ...
    while(ros::ok()) {
        ...
        try {
            ...
            // PID
            twist.linear.x = state_x * 0.005 + 0.005 *(state_x - last_error_x);
            twist.linear.y = state_y * 0.005 + 0.005 *(state_y - last_error_y);
